...
import { getFirestore, collection, getDocs, getDoc, doc, addDoc, serverTimestamp, where, runTransaction, query, orderBy, onSnapshot, updateDoc } from "firebase/firestore";
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            <View style={styles.container}>
                <View style={styles.form}>
                    ...
                    />
                    <TouchableOpacity style={{ backgroundColor: '#fb5b5a', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 10, marginTop: 20 }} onPress={() => submit()}>
